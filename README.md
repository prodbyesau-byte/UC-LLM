...
Installed and tested on 7 September 2026. Use the **Start Local AI Agent** desktop shortcut to open the standalone **Local Agent — NEON** Windows app. The selected connection profile is **LOCAL AGENT**. The browser URL **http://127.0.0.1:8000/** remains available as an alternative. See `desktop/README.md` for the app and cyberpunk skin.
